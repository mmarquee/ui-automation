...
/**
 * Windows specific tests for TreeView.
 *
...
public class TreeViewTest {
    ...
    public void setupMocks() throws Exception {
        ...
        ctrl = Mockito.spy(new TreeView(new ElementBuilder(element)));
    }
    ...
    public void testGetItem_When_Item_Is_Present() throws Exception {
        ...
        TreeViewItem treeItem = ctrl.getItem(Search.getBuilder("SubItem").build());
    ...
    public void testGetItem_with_RegExPattern_When_Item_Is_Present() throws Exception {
        ...
        TreeViewItem treeItem = ctrl.getItem(Search.getBuilder(Pattern.compile(".*yN.+")).build());
    ...
    public void testGetItemByAutomationId_When_Item_Present() throws Exception {
        ...
        TreeViewItem treeItem = ctrl.getItem(Search.getBuilder().automationId("autoId").build());
