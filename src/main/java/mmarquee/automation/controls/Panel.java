...
public class Panel extends Container {
     ...
     */
    public Panel(final ElementBuilder builder) {
        super(builder);
    }
     ...
     */
    @Deprecated
    private Window getMDIWindow(final int index)
     ...
     * @throws AutomationException Something went really wrong.
     */
    public Window getWindow(final Pattern namePattern)
            throws AutomationException {
        return new Window(
                new ElementBuilder(
     ...
     * @throws AutomationException Something has gone wrong.
      */
    public Window getWindowByAutomationId(final String id)
            throws AutomationException {
        return new Window(
                new ElementBuilder(
     ...
     * @throws AutomationException Something has gone wrong
     */
    public Window getMDIWindow(final Search search)
            throws AutomationException {
