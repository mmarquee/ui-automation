...
/**
 * Created by inpwt on 17/07/2016.
 */
...
/*
    int Get_AutoSetFocus(int AutoSetFocus);
    int Set_AutoSetFocus(int AutoSetFocus);
    int Get_ConnectionTimeout(WinDef.WORD timeout);  // LONGWORD?
    int Set_ConnectionTimeout(WinDef.WORD timeout);
    int Get_TransactionTimeout(WinDef.WORD timeout);
    int Set_TransactionTimeout(WinDef.WORD LongWord);
*/
    ...
    public static class Converter {
        ...
        private static int UIAutomation2_Methods  = 66; // 0-2 IUnknown, 3-57 IUIAutomation, 58-63 IUIAutomation2, 64-65 IUIAutomation3
